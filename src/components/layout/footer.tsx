...
const social = [
  ...
  {
    name: 'Email',
    href: 'mailto:hello@signtusk.com',
    icon: Mail,
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Secure document signing and sharing platform trusted by thousands of businesses worldwide.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">
                Get the latest product updates, security insights, and industry news.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              />
              <button className="px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
